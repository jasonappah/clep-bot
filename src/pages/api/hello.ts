...
export default async function handler(
  ...
  const promises = days.map((d) => fetch(`https://testing.verificient.com/614e76646a47455568375419/api/v-2/scheduler/available/slots/?selected_date=${d}T05:00:00.000Z&test_uuid=4a0bd817d11b4f5aa5bf4b2cec3cf1ba&localtime=${time}`, {
    "headers": {
      ...
      "x-csrftoken": "cMig7f2fkjQMUmL3K84ljIbWqu0brEKyBKhjkMpbWqfMtloXqpJwKVHFfMeSryCB",
      "cookie": "_ga=GA1.1.232096645.1692127525; _fw_crm_v=fae7526c-02a8-4d8b-9b91-b9026fc074d9; sessionid=fehqckrkqke5hjv7ypwo5i27s4xuey49; csrftoken=cMig7f2fkjQMUmL3K84ljIbWqu0brEKyBKhjkMpbWqfMtloXqpJwKVHFfMeSryCB; _ga_K48MZ4F4CE=GS1.1.1692186496.2.0.1692186500.0.0.0; _ga_5XH8N3KBGY=GS1.1.1692186500.2.0.1692186500.0.0.0",
